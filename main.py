...
def fetch_quote(ticker: str) -> Dict[str, Any]:
    """
    Returns dict with price info using yfinance intraday:
    { 'ticker', 'price', 'prev_close', 'change_pct_1d' }
    """
    t = yf.Ticker(ticker)
    info = {}
    try:
        hist = t.history(period="2d", interval="5m")  # intraday 5-minute candles
        ...
        info = {"ticker": ticker, "price": price, "prev_close": prev_close, "change_pct_1d": change_pct_1d}
    except Exception:
